...
def generate_pdf(order_number):
    try:
        ...
        for item in items:
            ...
            c.drawString(420, y, f"Rs.{item['price']}")
            c.drawString(500, y, f"Rs.{item['price'] * item['quantity']}")
            y -= 15
        ...
        c.drawString(500, y, f"Rs.{order['subtotal']:.2f}")
        y -= 15
        if order['discount'] > 0:
            c.drawString(400, y, "Discount:")
            c.drawString(500, y, f"-Rs.{order['discount']:.2f}")
            y -= 15
        c.drawString(400, y, "Tax:")
        c.drawString(500, y, f"Rs.{order['tax']:.2f}")
        y -= 15
        c.setFont("Helvetica-Bold", 12)
        c.drawString(400, y, "Total:")
        c.drawString(500, y, f"Rs.{order['total']:.2f}")
        y -= 30
        c.setFont("Helvetica", 10)
